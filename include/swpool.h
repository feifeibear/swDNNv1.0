...
extern int pooling_judge_small(int N,int C,int height_,int width_);
...
extern void pooling_forward_small_max_f(int N,int C,float *pTopData,const float *pBottomData,int*pMask,float *pTopMask,int nBottomOffset,
				int nTopOffset,int use_top_mask,int pooled_height_,int pooled_width_,int stride_h_,
				int stride_w_,int pad_h_,int pad_w_,int kernel_h_,int kernel_w_,int height_,int width_);

extern void pooling_forward_small_avg_f(int N,int C,float *pTopData,const float*pBottomData,int nBottomOffset,
				int nTopOffset,int pooled_height_,int pooled_width_,int stride_h_,
				int stride_w_,int pad_h_,int pad_w_,int kernel_h_,int kernel_w_,int height_,int width_);

extern void pooling_backward_small_max_f(int N,int C,const float *pTopData,float *pBottomData,const int*pMask,const float *pTopMask,int nBottomOffset,
				int nTopOffset,int use_top_mask,int pooled_height_,int pooled_width_,int stride_h_,
				int stride_w_,int pad_h_,int pad_w_,int kernel_h_,int kernel_w_,int height_,int width_);

extern void pooling_backward_small_avg_f(int N,int C,const float *pTopData,float*pBottomData,int nBottomOffset,
				int nTopOffset,int pooled_height_,int pooled_width_,int stride_h_,
				int stride_w_,int pad_h_,int pad_w_,int kernel_h_,int kernel_w_,int height_,int width_);
